...
describe('tests for reducers', function(){
  ...
  it('reducer should return correct state on success of fetching user', function() {
    ...
    const new_user = userDetails(newState,
      {type: 'SUCCESS_FETCH_USER'}).userDetails.user
  ...
  it('reducer should return error state on failure of fetching user', function() {
    ...
    const new_user = userDetails(errorState,
      {type: 'ERROR_FETCH_USER'}).userDetails.user
  ...
  it('reducer should return correct user feed images on success of fetching user feed images', function() {
    ...
    const userFeedImages = userDetails(newState,
      {type: 'SUCCESS_FETCH_USER_FEED_IMAGES'}).userDetails.userFeedImages
  ...
  it('reducer should return error state on failure of fetching user feed images', function() {
    ...
    const userFeedImages = userDetails(errorState,
      {type: 'ERROR_FETCH_USER_FEED_IMAGES'}).userDetails.userFeedImages
  ...
  it('reducer should return correct popular feed images on success of fetching popular feed images', function() {
    ...
    const popularFeedImages = userDetails(newState,
      {type: 'SUCCESS_FETCH_POPULAR_FEED_IMAGES'}).userDetails.popularFeedImages
  ...
  it('reducer should return error state on failure of fetching popular feed images', function() {
    ...
    const popularFeedImages = userDetails(errorState,
      {type: 'ERROR_FETCH_POPULAR_FEED_IMAGES'}).userDetails.popularFeedImages
